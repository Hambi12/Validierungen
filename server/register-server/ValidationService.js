...
function validateUser(userObj) {
    ...
    //check length
    result = validateLib.checkLength("username",userObj.username, 5, 20);
    if (result.isNotValid) { return result; }

    result = validateLib.checkLength("password", userObj.password, 8, 15);
    if (result.isNotValid) { return result; }
    ...
    result = validateLib.checkPassword("password", userObj.password2);
    if (result.isNotValid) { return result; }
